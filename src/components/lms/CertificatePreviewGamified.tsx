...
export const CertificatePreviewGamified: React.FC<CertificatePreviewProps> = ({
  ...
  return (
    <div className='space-y-4 security-card'>
      <div className='flex items-center justify-between'>
        <h3 className='text-lg font-semibold flex items-center gap-2'>
          <Award className='h-5 w-5 text-yellow-500' /> Certificate Preview
        ...
        <CardContent className='p-6'>
          <div className='certificate bg-gradient-to-r from-blue-50 to-purple-50 p-8 text-center rounded-lg border border-gray-200'>
            <div className='certificate-header border-b border-gray-200 pb-4 mb-4'>
              <img src='/lovable-uploads/876a553e-d478-4016-a8f0-1580f492ca19.png' alt='CSWORD Logo' className='h-12 mx-auto mb-2' />
            ...
            <div className='certificate-footer pt-4 mt-4 border-t border-gray-200'>
              <div className='flex justify-center items-center gap-4'>
                <div className='signature'>
                  <div className='h-px w-24 bg-gray-400 mb-1' />
...
export default CertificatePreviewGamified;
